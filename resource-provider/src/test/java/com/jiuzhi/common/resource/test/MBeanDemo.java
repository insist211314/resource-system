...
public class MBeanDemo {
    ...
    public static void main(String[] args) throws IOException, MalformedObjectNameException {
        ...
        try {
            ...
            ObjectName mBeanName = new ObjectName("com.appleframework:tttt=ddd");
            User u = new User();
            u.setName("daaaaaa");
            u.setdEnum(DEnum.AAA);
            Object params[] = {u};
            String signature[] = {"com.jiuzhi.common.resource.test.User"};
            Object object = null;
            try {
                 object = mbeanConn.invoke(mBeanName, "printGreeting", params, signature);
